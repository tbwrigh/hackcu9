...
countries &= set(map(lambda x: x.strip().lower(), wh_data["Country"].values.tolist())) # missing some countries 
# countries &= set(map(lambda x: x.strip().lower(), so_data["Country"].values.tolist()))
countries &= set(map(lambda x: x.strip().lower(), pop_data["Country"].values.tolist()))
